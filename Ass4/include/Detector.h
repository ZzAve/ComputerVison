...
class Detector
{
	...
	void readPosData(const std::vector<std::string> &, cv::Mat &,std::vector<std::vector<float>> &);
	void readNegData(const std::vector<std::string> &, cv::Mat &,std::vector<std::vector<float>> &);
